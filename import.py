...
#DBHelper().execute(u"TRUNCATE TABLE risks;")

'''df_projects = pd.ExcelFile(u'data/risks.xlsx').parse('risks')
for i, p in df_projects.T.iteritems():
    DBHelper().execute(u"INSERT INTO risks (description, description_en)"
                       u"VALUES ('%s', '%s');" %
